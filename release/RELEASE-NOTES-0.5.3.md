...
Build 14 passes all 262 XCTest cases in the development and public source trees,
and all 262 as x86_64 under Rosetta. The release bundles pass architecture,
signature, attribution, permissions, private-path, and checksum checks. The
extracted Apple silicon app was run directly from its release archive and its
physical Touch Bar display and independent task collection were observed.
...
[compatibility](https://github.com/mumchristmas/RehireBar/blob/v0.5.3/docs/COMPATIBILITY.md).
...
安装包仍为 ad-hoc 签名，尚未公证。262 项测试在本机原生及 Rosetta 环境均通过，
这些结果不代替原生 Intel 与双设备 Remote Control 的实机验收。
